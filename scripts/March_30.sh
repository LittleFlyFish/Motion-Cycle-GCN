...
python3 tools/train_conv.py --config ./configs/Motion_GCN_I10_O10_D15_G_conv3.py
python3 tools/train_conv.py --config ./configs/Motion_GCN_I10_O10_D15_G_convRELU.py
