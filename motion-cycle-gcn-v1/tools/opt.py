...
class Options:
    ...
    def _initial(self):
        ...
        #                     General options
        # ===============================================================
        self.parser.add_argument('--data_dir', type=str, default='/home/soe/Projects/MP_GCN/h3.6m/dataset', help='path to H36M dataset')
        ...
        self.parser.add_argument('--ckpt', type=str, default='/home/soe/Projects/MP_GCN/LearnTrajDep/checkpoint/', help='path to save checkpoint')
