...
class STGCN_encoder(nn.Module):
    def __init__(self, hidden_feature, layout, strategy, p_dropout, bias=True, node_n=48):
        ...
        self.st3 = st_gcn(hidden_feature, 2*hidden_feature, kernel_size, 2, residual=False)
        self.st4 = st_gcn(2*hidden_feature, hidden_feature, kernel_size, 2, residual=False)
        ...
        list2 = [[0,1,2,3,4]]
        self.gd2 = GraphDownSample(4*hidden_feature, 2*hidden_feature, list2)
...
class ST_E(nn.Module):
    ...
    def __init__(self, hidden_feature, layout="h36m", strategy="spatial", dropout=0.5, input_n=10, output_n=10, node_n=48):
        ...
        self.decoder = nn.Linear(2*hidden_feature*5, 66)
